define('ember-modal-dialog/components/deprecated-tether-dialog', ['exports', 'ember-modal-dialog/components/basic-dialog', 'ember-modal-dialog/templates/components/deprecated-tether-dialog'], function (exports, _basicDialog, _deprecatedTetherDialog) {
  ...
  exports.default = _basicDialog.default.extend({
    ...
    init: function init() {
      ...
      deprecate('Direct usage of `tether-dialog` is deprecated in favor of opting into tethering behavior by passing a `tetherTarget` to `modal-dialog`. Will be removed in 3.0.0.', false, { id: 'ember-modal-dialog.tether-dialog', until: '3.0.0' });
    },
    ...
    close: computed('onClose', {
      ...
      set: function set(key, value) {
        deprecate('Specifying the `close` action for a modal-dialog/tether-dialog is deprecated in favor of `onClose`. Will be removed in 3.0.0.', false, { id: 'ember-modal-dialog.close-action', until: '3.0.0' });
    ...
    "container-class": computed('containerClass', {
      ...
      set: function set(key, value) {
        deprecate('Passing `container-class` (kebab-case) is deprecated in favor of `containerClass` (camelCase). Will be removed in 3.0.0.', false, { id: 'ember-modal-dialog.kebab-props', until: '3.0.0' });
    ...
    "overlay-class": computed('overlayClass', {
      ...
      set: function set(key, value) {
        deprecate('Passing `overlay-class` (kebab-case) is deprecated in favor of `overlayClass` (camelCase). Will be removed in 3.0.0.', false, { id: 'ember-modal-dialog.kebab-props', until: '3.0.0' });
    ...
    "wrapper-class": computed('wrapperClass', {
      ...
      set: function set(key, value) {
        deprecate('Passing `wrapper-class` (kebab-case) is deprecated in favor of `wrapperClass` (camelCase). Will be removed in 3.0.0.', false, { id: 'ember-modal-dialog.kebab-props', until: '3.0.0' });
